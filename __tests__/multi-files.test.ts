...
describe('multi report', () => {
  ...
  test('should generate markdown for one file', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      | --- | --- | --- | --- | --- |
      | title1 | <a href="https://github.com/undefined/blob/undefined/README.md"><img alt="undefined: 78%" src="https://img.shields.io/badge/undefined-78%25-yellow.svg" /></a><br/> ▲ Increased (+78%) | 76.74% (33/43) | 100% (0/0) | 33.33% (2/6) |
      "
    `)
  })
  ...
  test('should generate markdown for two files', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      | --- | --- | --- | --- | --- |
      | title1 | <a href="https://github.com/undefined/blob/undefined/README.md"><img alt="undefined: 78%" src="https://img.shields.io/badge/undefined-78%25-yellow.svg" /></a><br/> ▲ Increased (+78%) | 76.74% (33/43) | 100% (0/0) | 33.33% (2/6) |
      | title2 | <a href="https://github.com/undefined/blob/undefined/README.md"><img alt="undefined: 79%" src="https://img.shields.io/badge/undefined-79%25-yellow.svg" /></a><br/> ▲ Increased (+79%) | 77.27% (34/44) | 100% (0/0) | 33.33% (2/6) |
      "
    `)
  })
})
